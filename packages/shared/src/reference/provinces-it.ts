// Province italiane (sigla auto, nome ufficiale).
export interface Provincia {
  sigla: string;
  nome: string;
}

export const PROVINCE_IT: Provincia[] = [
...
const SIGLE = new Set(PROVINCE_IT.map((p) => p.sigla));
export const isValidProvinciaIT = (v: string) => SIGLE.has(v);
